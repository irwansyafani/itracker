...
/* package isupply-0.1.0.0 */
#ifndef VERSION_isupply
#define VERSION_isupply "0.1.0.0"
#endif /* VERSION_isupply */
#ifndef MIN_VERSION_isupply
#define MIN_VERSION_isupply(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_isupply */
